...
function Navbar() {
    ...
    return (
        <div
            className={` items-center align-middle w-[80%]  mx-auto rounded-[40px] p-4 ${
        ...
        >
            <div className="flex justify-between items-center  md:px-24 px-6">
                ...
                <div className="flex justify-center flex-grow items-center">
                    ...
                    >
                        <Link to="/">
                            <li className="text-[#444444] duration-300 ease-in border-transparent hover:border-[#444444] px-3 py-2 rounded-[40px] hover:bg-[#c5fcfc] hover:text-black">
                                Home
                            </li>
                        </Link>
                        <Link to="/">
